...
import ie.nok.ber.auth.store.ApiKeyStore
...
object ApiKeyInMemoryStore extends ApiKeyStore {
  ...
  private val apiKeyMap: Map[String, ApiKey] = Map(
    ...
    "wcvopwsidfu12dsodiw23c" -> Tuple2("dev@nok.ie", ApiKeyType.Dev),
    "rew98kerrjrjewfj3332mn" -> Tuple2("user@nok.ie", ApiKeyType.User)
